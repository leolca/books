...
cp pdf_pages/livropipocanao000-cover_en.pdf "${TEMP_DIR}/01.pdf"
cp pdf_pages/livropipocanao-i_en.pdf "${TEMP_DIR}/02.pdf"
cp pdf_pages/livropipocanao-ii_en.pdf "${TEMP_DIR}/03.pdf"
cp pdf_pages/livropipocanao-iii_en.pdf "${TEMP_DIR}/04.pdf"
cp pdf_pages/livropipocanao001_en.pdf "${TEMP_DIR}/05.pdf"
cp pdf_pages/livropipocanao002_en.pdf "${TEMP_DIR}/06.pdf"
cp pdf_pages/livropipocanao003_en.pdf "${TEMP_DIR}/07.pdf"
cp pdf_pages/livropipocanao004_en.pdf "${TEMP_DIR}/08.pdf"
cp pdf_pages/livropipocanao005_en.pdf "${TEMP_DIR}/09.pdf"
cp pdf_pages/livropipocanao006_en.pdf "${TEMP_DIR}/10.pdf"
cp pdf_pages/livropipocanao007_en.pdf "${TEMP_DIR}/11.pdf"
cp pdf_pages/livropipocanao008_en.pdf "${TEMP_DIR}/12.pdf"
cp pdf_pages/livropipocanao009_en.pdf "${TEMP_DIR}/13.pdf"
cp pdf_pages/livropipocanao010_en.pdf "${TEMP_DIR}/14.pdf"
cp pdf_pages/livropipocanao011_en.pdf "${TEMP_DIR}/15.pdf"
cp pdf_pages/livropipocanao012_en.pdf "${TEMP_DIR}/16.pdf"
cp pdf_pages/livropipocanao013_en.pdf "${TEMP_DIR}/17.pdf"
...
#rm ${TEMP_DIR}/*
#mutool poster -x 2 pdf_pages/livropipocanao000-cover_en.pdf "${TEMP_DIR}/temp.pdf"
...
pdftk booklet_pipoca_en.pdf cat 2-33 output /tmp/manuscript.pdf
...
convert -density 150 pdf_pages/livropipocanao000-cover_en.pdf /tmp/cover.jpg
