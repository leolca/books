...
transmissão de informação\index{informação} de forma eficiente. Informação, um conceito abstrato,
...
Assim, determinada informação\index{informação} pode ser representada na forma de dados de
...
propuseram o código Morse\index{código!Morse}, como uma forma econômica de se comunicar através das
...
Também no século XIX, foi criada a escrita noturna\index{código!Escrita Noturna} por Charles Barbier. Esta
...
combinações binárias. O código Braille\index{código!Braille}, inicialmente proposto para o francês,
...
Usualmente, quando falamos da representação de informação\index{informação}, pensamos na escrita
...
aos estudos de Thomas Harriot e Gottfried Leibniz, nos séculos XVI e XVII \parencite{shirley1951}.
\footnote{Thomas Harriot (c. 1560–1621) investigou formas alternativas de
notação matemática, incluindo representações próximas ao binário, embora seus
escritos tenham permanecido inéditos em vida. Gottfried Wilhelm Leibniz
(1646–1716), por sua vez, publicou em 1703 o ensaio \textit{Explication de
l'Arithmétique Binaire}, no qual formalizou o sistema binário como base
aritmética, relacionando-o também ao simbolismo do I Ching chinês \parencite{shirley1951,Zandonade2024}.}
No entanto,
...
informação\index{informação} poderia ser codificada e transmitida de forma eficiente, Shannon
