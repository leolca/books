...
\usepackage[unicode,hyperfootnotes=false,xetex]{hyperref}
  \hypersetup{%
    pdfborder = {0 0 0},
...
%% Definindo o fim do example
%\usepackage{xpatch}
%\xpatchcmd{\endexample}
%  {\endtrivlist}
%  {\smallskip\hfill\rule{3em}{0.4pt}\hfill\medskip\endtrivlist}
%  {}{\fail}
...
\hyphenation{dis-tri-bui-ção dis-tri-bui-ções} 
...
\input{aleatoriedade.tex}

\input{principios.tex}

\input{propeqassintotica.tex}

\input{procestocasticos.tex}

\input{codigos.tex}

\input{canal.tex}

\input{correcaoerro.tex}
