...
\begin{theorem}[Propriedade da Equipartição Assintótica\index{propriedade da equipartição assintóticas}]\label{thm-prop-eqp-ass}
...
\begin{theorem}[Primeiro Teorema de Shannon\index{teorema!primeiro teorema de Shannon (teorema da codificação de fonte)}]
...
A demonstração do primeiro teorema de Shannon utiliza sequências típicas\index{sequências típicas} para
...
\begin{theorem}[Teorema da Codificação de Shannon\index{teorema!primeiro teorema de Shannon (teorema da codificação de fonte)}]\label{thm:teocodshannontipos}
