...
Aleatoriedade é vital em diversas aplicações, como criptografia, simulações computacionais,
...
Lava Lamps \parencite{cloudflare}.
...
aleatórios são fundamentais para a criptografia. A segurança de algoritmos
...
Gerador de Números Pseudoaleatórios Criptograficamente Seguro (CSPRNG\footnote{Cryptographically secure pseudorandom number generator.})
...
única vez em diversos protocolos necessitam de valores únicos e imprevisíveis
...
Encryption Standard}) no modo \textit{Counter} (CTR). Nesse esquema, uma chave
