...
cp pdf_pages/pipoca_capa_en.pdf "${TEMP_DIR}/01.pdf"
pdfjam pdf_pages/pipoca_i_en.pdf pdf_pages/pipoca_ii_en.pdf --nup 2x1 --landscape --a4paper --outfile "${TEMP_DIR}/02.pdf" --quiet
pdfjam pdf_pages/pipoca_iii_en.pdf pdf_pages/pipoca_iv_en.pdf --nup 2x1 --landscape --a4paper --outfile "${TEMP_DIR}/03.pdf" --quiet
cp pdf_pages/pipoca01_en.pdf "${TEMP_DIR}/04.pdf"
cp pdf_pages/pipoca02_en.pdf "${TEMP_DIR}/05.pdf"
cp pdf_pages/pipoca03_en.pdf "${TEMP_DIR}/06.pdf"
cp pdf_pages/pipoca04_en.pdf "${TEMP_DIR}/07.pdf"
cp pdf_pages/pipoca05_en.pdf "${TEMP_DIR}/08.pdf"
cp pdf_pages/pipoca06_en.pdf "${TEMP_DIR}/09.pdf"
cp pdf_pages/pipoca07_en.pdf "${TEMP_DIR}/10.pdf"
cp pdf_pages/pipoca08_en.pdf "${TEMP_DIR}/11.pdf"
cp pdf_pages/pipoca09_en.pdf "${TEMP_DIR}/12.pdf"
cp pdf_pages/pipoca10_en.pdf "${TEMP_DIR}/13.pdf"
cp pdf_pages/pipoca11_en.pdf "${TEMP_DIR}/14.pdf"
cp pdf_pages/pipoca12_en.pdf "${TEMP_DIR}/15.pdf"
cp pdf_pages/pipoca13_en.pdf "${TEMP_DIR}/16.pdf"
...
rm ${TEMP_DIR}/*
mutool poster -x 2 pdf_pages/pipoca_capa_en.pdf "${TEMP_DIR}/temp.pdf"
pdfseparate "${TEMP_DIR}/temp.pdf" "${TEMP_DIR}/cover%d.pdf"
for i in {1..13}; 
  do 
  echo $i;
  formatted_i=$(printf "%02d" "$i")
  mutool poster -x 2 "pdf_pages/pipoca${formatted_i}_en.pdf" "${TEMP_DIR}/temp.pdf"
  pdfseparate "${TEMP_DIR}/temp.pdf" "${TEMP_DIR}/booklet${formatted_i}_%d.pdf"
done

pdftk ${TEMP_DIR}/cover2.pdf pdf_pages/pipoca_i_en.pdf pdf_pages/pipoca_ii_en.pdf pdf_pages/pipoca_iii_en.pdf pdf_pages/pipoca_iv_en.pdf ${TEMP_DIR}/booklet* ${TEMP_DIR}/cover1.pdf cat output booklet_pipoca_en.pdf
