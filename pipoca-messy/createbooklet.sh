...
cp pdf_pages/pipoca-messy-capa.pdf "${TEMP_DIR}/01.pdf"
cp pdf_pages/pipoca-messy-i.pdf "${TEMP_DIR}/02.pdf"
cp pdf_pages/pipoca-messy-ii.pdf "${TEMP_DIR}/03.pdf"
cp pdf_pages/pipoca-messy-iii.pdf "${TEMP_DIR}/04.pdf"
cp pdf_pages/pipoca-messy-001.pdf "${TEMP_DIR}/05.pdf"
cp pdf_pages/pipoca-messy-002.pdf "${TEMP_DIR}/06.pdf"
cp pdf_pages/pipoca-messy-003.pdf "${TEMP_DIR}/07.pdf"
cp pdf_pages/pipoca-messy-004.pdf "${TEMP_DIR}/08.pdf"
cp pdf_pages/pipoca-messy-005.pdf "${TEMP_DIR}/09.pdf"
cp pdf_pages/pipoca-messy-006.pdf "${TEMP_DIR}/10.pdf"
cp pdf_pages/pipoca-messy-007.pdf "${TEMP_DIR}/11.pdf"
cp pdf_pages/pipoca-messy-008.pdf "${TEMP_DIR}/12.pdf"
cp pdf_pages/pipoca-messy-009.pdf "${TEMP_DIR}/13.pdf"
cp pdf_pages/pipoca-messy-010.pdf "${TEMP_DIR}/14.pdf"
cp pdf_pages/pipoca-messy-011.pdf "${TEMP_DIR}/15.pdf"
cp pdf_pages/pipoca-messy-012.pdf "${TEMP_DIR}/16.pdf"
cp pdf_pages/pipoca-messy-013.pdf "${TEMP_DIR}/17.pdf"
cp pdf_pages/pipoca-messy-014.pdf "${TEMP_DIR}/18.pdf"
...
#rm ${TEMP_DIR}/*
#mutool poster -x 2 pdf_pages/pipoca-messy-000-cover.pdf "${TEMP_DIR}/temp.pdf"
...
pdftk booklet_pipoca.pdf cat 2-35 output /tmp/manuscript.pdf
...
convert -density 150 pdf_pages/pipoca-messy-capa.pdf /tmp/cover.jpg
pdftk booklet_pipoca.pdf cat 1 output /tmp/covers.pdf
